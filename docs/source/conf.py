# -*- coding: utf-8 -*-
#
# cds-fossir documentation build configuration file, created by
# sphinx-quickstart on Sun Jan 7 18:00:20 2018.
#
...
os.environ['fossir_CONFIG'] = os.path.join(os.path.dirname(__file__), '..', '..', 'fossir', 'fossir.conf.sample')
...
issues_github_path = 'fossir/fossir'
...
latex_documents = [
  ('index', 'fossir.tex', u'fossir Documentation',
   u'fossir Team', 'manual'),
]
