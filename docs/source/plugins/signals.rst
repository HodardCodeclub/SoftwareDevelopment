Hooking into fossir using Signals
=================================

.. contents::
    :depth: 3

Signals allow you to hook into certain parts of fossir without
...
To avoid breakage with newer versions of fossir, it is highly
        ...
        def generate_signal_doc(module, nesting=0):
            ...
            for attr, name in sorted_attributes:
                ...
                # don't recurse in those cases to avoid duplicate docs
                        ...
                        name != 'core' and module.__name__ != 'fossir.core.signals.event'):
                    print attr.__name__
