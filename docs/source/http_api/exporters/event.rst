...
Result for https://fossir.server/export/event/137346.json?occ=yes&pretty=yes::

    {
        "count": 1,
        "_type": "HTTPAPIResult",
        "complete": true,
        "url": "https://fossir.server/export/event/137346.json?occ=yes&pretty=yes",
        "ts": 1308899256,
        "results": [
            {
                ...
                "description": "",
                "title": "Export Test",
                "url": "http://fossir.server/conferenceDisplay.py?confId=137346",
                "room": null,
                "occurrences": [
                    {
                        "_fossil": "period",
...
Output for https://fossir.server/export/event/137346.json?detail=contributions&pretty=yes::

    {
        "count": 1,
        "_type": "HTTPAPIResult",
        "complete": true,
        "url": "https://fossir.server/export/event/137346.json?detail=contributions&pretty=yes",
        "ts": 1308899252,
        "results": [
            {
                "category": "TEST Category",
...
For example, https://fossir.server/export/event/137346.json?detail=sessions&pretty=yes::

    {
        "count": 1,
        "_type": "HTTPAPIResult",
        "complete": true,
        "url": "https://fossir.server/export/event/137346.json?detail=sessions&pretty=yes",
        "ts": 1308899771,
        "results": [
            {
                "category": "TEST Category",
