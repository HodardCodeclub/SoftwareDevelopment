...
from fossir.core.settings import PrefixSettingsProxy, SettingsProxy
from fossir.core.settings.converters import DatetimeConverter, TimedeltaConverter
...
def test_delete_propagate(mocker):
    ...
    SettingPrincipal = mocker.patch('fossir.core.settings.proxy.SettingPrincipal')
    proxy = SettingsProxy('foo', {'reg': None}, acls={'acl'})
