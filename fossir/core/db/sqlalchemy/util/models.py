...
from fossir.util.packaging import get_package_root_path


class fossirBaseQuery(BaseQuery):
...
def import_all_models(package_name='fossir'):
    """Utility that imports all modules in fossir/**/models/
