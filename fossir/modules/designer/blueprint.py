...
from fossir.modules.designer.controllers import (RHAddCategoryTemplate, RHAddEventTemplate, RHCloneCategoryTemplate,
...
_bp = fossirBlueprint('designer', __name__, template_folder='templates', virtual_template_folder='designer')
