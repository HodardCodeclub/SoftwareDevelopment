...
from fossir.core.settings import PrefixSettingsProxy
from fossir.modules.admin import RHAdminBase
from fossir.modules.cephalopod import cephalopod_settings
from fossir.modules.core.forms import ReportErrorForm, SettingsForm
from fossir.modules.core.settings import core_settings, social_settings
from fossir.modules.core.views import WPContact, WPSettings
from fossir.util.i18n import _
from fossir.web.errors import load_error_data
...
class RHVersionCheck(RHAdminBase):
    """Check the installed fossir version against pypi"""
    ...
    def _process(self):
        return jsonify(fossir=self._check_version('fossir', fossir.__version__),
                       plugins=self._check_version('fossir-plugins'))
