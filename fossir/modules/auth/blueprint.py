...
from fossir.modules.auth.controllers import (RHAccounts, RHAdminImpersonate, RHLinkAccount, RHLogin, RHLoginForm,
...
_bp = fossirBlueprint('auth', __name__, template_folder='templates', virtual_template_folder='auth')
...
# Legacy URLs
auth_compat_blueprint = _compat_bp = fossirBlueprint('compat_auth', __name__)
