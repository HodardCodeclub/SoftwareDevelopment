...
from fossir.modules.categories.compat import compat_category
from fossir.modules.categories.controllers.admin import RHManageUpcomingEvents
from fossir.modules.categories.controllers.display import (RHCategoryCalendarView, RHCategoryIcon, RHCategoryInfo,
...
from fossir.modules.categories.controllers.management import (RHCreateCategory, RHDeleteCategory, RHDeleteEvents,
...
_bp = fossirBlueprint('categories', __name__, template_folder='templates', virtual_template_folder='categories',
...
def _redirect_to_bootstrap():
    # No users in fossir yet? Redirect from index page to bootstrap form
...
_compat_bp = fossirBlueprint('compat_categories', __name__)
