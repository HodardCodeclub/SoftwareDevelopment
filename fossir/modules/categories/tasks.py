...
from fossir.modules.categories import Category, logger
from fossir.modules.users import User, UserSetting
from fossir.modules.users.models.suggestions import SuggestedCategory
from fossir.modules.users.util import get_related_categories
from fossir.util.date_time import now_utc
from fossir.util.suggestions import get_category_scores
