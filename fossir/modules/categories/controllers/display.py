...
from fossir.modules.categories.legacy import XMLCategorySerializer
from fossir.modules.categories.models.categories import Category
from fossir.modules.categories.serialize import (serialize_categories_ical, serialize_category, serialize_category_atom,
                                                 serialize_category_chain)
from fossir.modules.categories.util import get_category_stats, get_upcoming_events
from fossir.modules.categories.views import WPCategory, WPCategoryStatistics
from fossir.modules.events.models.events import Event
from fossir.modules.events.timetable.util import get_category_timetable
...
from fossir.modules.users.models.favorites import favorite_category_table
from fossir.util.date_time import format_date, format_number, now_utc
