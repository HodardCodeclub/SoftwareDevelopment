...
from fossir.core.db.sqlalchemy.links import LinkMixin
from fossir.core.db.sqlalchemy.protection import ProtectionMixin, ProtectionMode
...
from fossir.modules.attachments.models.principals import AttachmentFolderPrincipal
...
class AttachmentFolder(LinkMixin, ProtectionMixin, db.Model):
    ...
    def get_for_linked_object(cls, linked_object, preload_event=False):
        ...
        :param preload_event: If all attachments for the same event should
                              ...
                              is a category.
        """
        from fossir.modules.attachments.api.util import get_event
