...
from fossir.core.db.sqlalchemy.protection import ProtectionMixin
from fossir.core.db.sqlalchemy.util.session import no_autoflush
from fossir.core.storage import StoredFileMixin, VersionedResourceMixin
from fossir.modules.attachments.models.principals import AttachmentPrincipal
