...
from fossir.legacy.services.interface.rpc.json import process as jsonrpc_handler
from fossir.modules.api.controllers import (RHAPIAdminKeys, RHAPIAdminSettings, RHAPIBlockKey, RHAPIBuildURLs,
...
from fossir.web.http_api.handlers import handler as api_handler


_bp = fossirBlueprint('api', __name__, template_folder='templates', virtual_template_folder='api')
