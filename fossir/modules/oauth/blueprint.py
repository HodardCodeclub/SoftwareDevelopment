...
from fossir.modules.oauth.controllers import (RHOAuthAdmin, RHOAuthAdminApplication, RHOAuthAdminApplicationDelete,
...
_bp = fossirBlueprint('oauth', __name__, template_folder='templates', virtual_template_folder='oauth')
