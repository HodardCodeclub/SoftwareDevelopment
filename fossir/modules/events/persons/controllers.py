...
from fossir.modules.events.persons.forms import EmailEventPersonsForm, EventPersonForm
from fossir.modules.events.persons.operations import update_person
from fossir.modules.events.persons.views import WPManagePersons
...
from fossir.web.flask.util import jsonify_data, url_for
from fossir.web.forms.base import FormDefaults
from fossir.web.util import jsonify_form, jsonify_template
