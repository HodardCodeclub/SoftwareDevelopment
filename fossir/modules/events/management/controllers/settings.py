...
from fossir.modules.events.management.forms import (EventClassificationForm, EventContactInfoForm, EventDataForm,
                                                    EventDatesForm, EventLocationForm, EventPersonsForm)
from fossir.modules.events.management.util import flash_if_unregistered
from fossir.modules.events.management.views import WPEventSettings, render_event_management_header_right
from fossir.modules.events.operations import update_event
