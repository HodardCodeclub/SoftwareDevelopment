...
def flash_if_unregistered(event, get_person_links):
    ...
    warning = ngettext('You have added a user with no fossir account.',
                       'You have added {} users with no fossir account.', added_non_users).format(added_non_users)
    msg = _('An fossir account may be needed to upload materials and/or manage contents.')
