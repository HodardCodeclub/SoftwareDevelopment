...
from fossir.core.db.sqlalchemy.principals import EmailPrincipal, PrincipalType
from fossir.core.db.sqlalchemy.protection import ProtectionMode
from fossir.core.roles import get_available_roles
...
def _mock_available_roles(mocker):
    ...
    mocker.patch('fossir.core.db.sqlalchemy.protection.get_available_roles', return_value=roles)
    mocker.patch('fossir.core.db.sqlalchemy.principals.get_available_roles', return_value=roles)
