...
from fossir.core.db.sqlalchemy.protection import ProtectionManagersMixin, ProtectionMode
from fossir.core.db.sqlalchemy.searchable_titles import SearchableTitleMixin
from fossir.core.db.sqlalchemy.util.models import auto_table_args
from fossir.core.db.sqlalchemy.util.queries import db_dates_overlap, get_related_object
...
from fossir.modules.events.models.persons import PersonLinkDataMixin
from fossir.modules.events.settings import EventSettingProperty, event_contact_settings, event_core_settings
from fossir.modules.events.timetable.models.entries import TimetableEntry
from fossir.util.caching import memoize_request
from fossir.util.date_time import get_display_tz, now_utc, overlaps
from fossir.util.decorators import strict_classproperty
from fossir.util.i18n import _
from fossir.util.string import format_repr, return_ascii, text_to_repr, to_unicode
...
def _set_start_end_dt(target, value, oldvalue, *unused):
    from fossir.modules.events.util import register_event_time_change
