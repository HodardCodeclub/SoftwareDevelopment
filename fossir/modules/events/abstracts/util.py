...
from fossir.legacy.pdfinterface.conference import AbstractBook
...
from fossir.modules.events.abstracts.models.email_templates import AbstractEmailTemplate
...
from fossir.modules.events.abstracts.settings import abstracts_settings, boa_settings
...
def make_abstract_form(event, notification_option=False, management=False):
    ...
    """
    from fossir.modules.events.abstracts.forms import (AbstractForm, MultiTrackMixin, SingleTrackMixin, NoTrackMixin,
