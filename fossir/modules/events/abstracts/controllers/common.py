...
from fossir.legacy.pdfinterface.conference import AbstractsToPDF, ConfManagerAbstractsToPDF
from fossir.modules.events.abstracts.models.files import AbstractFile
from fossir.modules.events.abstracts.util import generate_spreadsheet_from_abstracts
