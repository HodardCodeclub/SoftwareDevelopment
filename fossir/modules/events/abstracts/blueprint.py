...
from fossir.modules.events.abstracts.compat import compat_abstract
from fossir.modules.events.abstracts.controllers import (abstract, abstract_list, boa, display, email_templates,
...
_bp = fossirBlueprint('abstracts', __name__, url_prefix='/event/<confId>', template_folder='templates',
...
# Legacy URLs - display
_compat_bp = fossirBlueprint('compat_abstracts', __name__, url_prefix='/event/<int:confId>')
