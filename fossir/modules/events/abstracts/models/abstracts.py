...
from fossir.modules.events.contributions.models.contributions import CustomFieldsMixin, _get_next_friendly_id
from fossir.modules.events.models.persons import AuthorsSpeakersMixin
from fossir.modules.events.models.reviews import ProposalMixin, ProposalRevisionMixin
from fossir.util.date_time import now_utc
from fossir.util.i18n import _
from fossir.util.locators import locator_property
from fossir.util.string import MarkdownText, format_repr, return_ascii, text_to_repr
from fossir.util.struct.enum import fossirEnum, RichIntEnum
...
class EditTrackMode(int, fossirEnum):
    none = 0
    both = 1
    reviewed_for = 2
