...
from fossir.modules.events.contributions import logger
...
from fossir.modules.events.timetable.operations import (delete_timetable_entry, schedule_contribution,
