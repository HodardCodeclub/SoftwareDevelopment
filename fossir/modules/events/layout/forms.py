...
from fossir.modules.events.layout.util import get_css_file_data, get_logo_data, get_plugin_conference_themes
from fossir.util.i18n import _
from fossir.web.forms.base import fossirForm
from fossir.web.forms.fields import EditableFileField, FileField
from fossir.web.forms.validators import HiddenUnless, UsedIf
from fossir.web.forms.widgets import CKEditorWidget, ColorPickerWidget, SwitchWidget
...
class LectureMeetingLayoutForm(fossirForm):
...
class MenuUserEntryFormBase(fossirForm):
