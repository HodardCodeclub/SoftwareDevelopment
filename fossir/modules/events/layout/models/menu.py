...
from fossir.util.string import format_repr, return_ascii, slugify, text_to_repr
...
class MenuEntryMixin(object):
    ...
    def default_data(self):
        from fossir.modules.events.layout.util import get_menu_entries_from_signal
