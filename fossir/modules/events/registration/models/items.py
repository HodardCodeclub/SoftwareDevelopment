...
from fossir.util.string import camelize_keys, format_repr, return_ascii
...
class RegistrationFormItemType(int, fossirEnum):
    section = 1
    field = 2
    text = 3
...
class PersonalDataType(int, fossirEnum):
