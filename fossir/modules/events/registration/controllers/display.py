...
from fossir.modules.events.payment import payment_event_settings
from fossir.modules.events.registration import registration_settings
from fossir.modules.events.registration.controllers import RegistrationEditMixin, RegistrationFormMixin
...
from fossir.modules.events.registration.models.registrations import Registration, RegistrationState
from fossir.modules.events.registration.util import (check_registration_email, create_registration, get_event_regforms,
                                                     get_event_section_data, get_title_uuid, make_registration_form)
from fossir.modules.events.registration.views import (WPDisplayRegistrationFormConference,
    ...
    def _process_args(self):
        ...
        if self.registration is None:
            if session.user:
                ...
                flash(_("We could not find a registration for you.  If have already registered, please use the "
                        "direct access link from the email you received after registering or log in to your fossir "
                        "account."), 'warning')
