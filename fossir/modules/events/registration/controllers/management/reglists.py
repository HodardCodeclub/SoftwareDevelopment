...
from fossir.legacy.pdfinterface.conference import RegistrantsListToBookPDF, RegistrantsListToPDF
from fossir.modules.designer import PageLayout
...
from fossir.modules.events.payment.models.transactions import TransactionAction
from fossir.modules.events.payment.util import register_transaction
from fossir.modules.events.registration import logger
from fossir.modules.events.registration.badges import (RegistrantsListToBadgesPDF,
                                                       RegistrantsListToBadgesPDFDoubleSided,
                                                       RegistrantsListToBadgesPDFFoldable)
from fossir.modules.events.registration.controllers import RegistrationEditMixin
from fossir.modules.events.registration.controllers.management import (RHManageRegFormBase, RHManageRegFormsBase,
                                                                       RHManageRegistrationBase)
from fossir.modules.events.registration.forms import (BadgeSettingsForm, CreateMultipleRegistrationsForm,
...
from fossir.modules.events.registration.settings import event_badge_settings
...
class RHRegistrationCreateMultiple(RHManageRegFormBase):
    """Create multiple registrations for fossir users (management area)"""
...
class RHRegistrationsConfigBadges(RHRegistrationsActionBase):
    ...
    def _get_format(self, tpl):
        from fossir.modules.designer.pdf import PIXELS_CM
