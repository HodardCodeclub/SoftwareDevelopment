...
from fossir.modules.events.registration.fields.base import RegistrationFormBillableField, RegistrationFormFieldBase
from fossir.util.countries import get_countries, get_country
from fossir.util.date_time import strftime_all_years
from fossir.util.fs import secure_filename
from fossir.util.i18n import L_, _
from fossir.util.string import normalize_phone_number
...
class BooleanField(RegistrationFormBillableField):
    name = 'bool'
    wtf_field_class = fossirRadioField
    required_validator = InputRequired
    friendly_data_mapping = {None: '',
                             True: L_('Yes'),
                             False: L_('No')}
