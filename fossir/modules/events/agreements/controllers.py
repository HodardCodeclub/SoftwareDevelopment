...
from fossir.modules.events.agreements.forms import AgreementAnswerSubmissionForm, AgreementEmailForm, AgreementForm
from fossir.modules.events.agreements.models.agreements import Agreement, AgreementState
from fossir.modules.events.agreements.notifications import notify_agreement_reminder, notify_new_signature_to_manager
from fossir.modules.events.agreements.util import get_agreement_definitions, send_new_agreements
from fossir.modules.events.agreements.views import (WPAgreementFormConference, WPAgreementFormSimpleEvent,
                                                    WPAgreementManager)
...
class RHAgreementForm(RHDisplayEventBase):
    ...
    def _check_access(self):
        ...
        # or not.  Speakers might not even have an fossir account...
