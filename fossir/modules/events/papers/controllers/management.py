...
from fossir.modules.events.papers.controllers.base import RHManagePapersBase
from fossir.modules.events.papers.forms import (DeadlineForm, PaperReviewingSettingsForm, PapersScheduleForm,
                                                PaperTeamsForm, make_competences_form)
from fossir.modules.events.papers.models.reviews import PaperReviewType
from fossir.modules.events.papers.operations import (close_cfp, create_competences, open_cfp, schedule_cfp,
...
from fossir.modules.events.papers.views import WPManagePapers
