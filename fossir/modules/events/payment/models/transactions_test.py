...
from fossir.modules.events.payment.models.transactions import (DoublePaymentTransaction, IgnoredTransactionAction,
...
from fossir.testing.util import extract_logs


pytest_plugins = 'fossir.modules.events.payment.testing.fixtures'
...
def test_create_next_with_exception(caplog, mocker, creation_params, exception):
    ...
    transaction = PaymentTransaction.create_next(**creation_params)
    log = extract_logs(caplog, one=True, name='fossir.payment')
