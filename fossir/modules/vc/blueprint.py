...
from fossir.modules.vc.controllers import (RHVCEventPage, RHVCManageAttach, RHVCManageEvent, RHVCManageEventCreate,
...
_bp = fossirBlueprint('vc', __name__, template_folder='templates', virtual_template_folder='vc')
...
# Legacy URLs
vc_compat_blueprint = _compat_bp = fossirBlueprint('compat_vc', __name__)
