...
(function($, undefined) {
    ...
    $.widget("fossir.reset_resizable", $.ui.resizable, {
    ...
    $.widget("fossir.super_draggable", $.ui.draggable, {
    ...
    // is on top
    $.widget("fossir.super_droppable", $.ui.droppable, {
    ...
    $.widget('fossir.disabledElementWithTooltip', {
        // Default options
        options: {
            disabled: null,
            tooltip: null,
