...
*/
(function($, undefined) {
    $.widget('fossir.disabledButtonWithTooltip',  $.extend({}, $.fossir.disabledElementWithTooltip, {
        // Default options
        options: {
        ...
        _create: function() {
            ...
            $.fossir.disabledElementWithTooltip.prototype._create.apply(this, arguments);
        },
        ...
        destroy: function() {
            $.fossir.disabledElementWithTooltip.prototype.destroy.apply(this, arguments);
