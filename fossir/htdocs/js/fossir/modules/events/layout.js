...
(function(global) {
    ...
    }).on('fossir:confirmed', '.menu-entry .enabled, .menu-entry .not-enabled', function(evt) {
        evt.stopPropagation();
        evt.preventDefault();
    ...
    }).on('fossir:confirmed', '.menu-entry .default, .menu-entry .not-default', function(evt) {
        evt.stopPropagation();
        evt.preventDefault();
    ...
    }).on('fossir:confirmed', '.menu-entry .delete-entry', function(evt) {
        evt.preventDefault();
