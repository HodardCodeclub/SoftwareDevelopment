...
(function($) {
    ...
    $.widget('fossir.categorynavigator', {
        options: {
        ...
        _fetchCategory: function(id, callback) {
            ...
            self._currentCategoryRequest = $.ajax({
                url: build_url(fossir.Urls.Categories.info, {category_id: id}),
                dataType: 'json',
                beforeSend: function() {
        ...
        _fetchReachableCategories: function(id) {
            var self = this;
            $.ajax({
                url: build_url(fossir.Urls.Categories.infoFrom, {category_id: id}),
                method: 'POST',
                dataType: 'json',
        ...
        _fetchSearchResults: function(query, callback) {
            ...
            self._currentSearchRequest = $.ajax({
                url: build_url(fossir.Urls.Categories.search),
                data: {q: query},
                beforeSend: function() {
