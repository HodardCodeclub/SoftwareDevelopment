...
fossirUI.Widgets = {
    ...
    Generic: {
         ...
         *     fossirUI.Widgets.Generic.tooltip(this, event, "<span style='padding:3px'>Go to fossir Home Page</span>");
         * }
            ...
            elem.processDate = function(){
                ...
                if (showTime) {
                    if (exists(format)) {
                        ...
                        d = fossirUtil.parseDateTime(elem.get());
                    }
                } else {
                    if (exists(format)) {
                        d = Util.parseJSDateTime(elem.get(), format);
        ...
        dateField: function(showTime, attributes, hiddenFields, elemInfo, format, callback){
            ...
            fossirUI.Widgets.Generic.input2dateField(elem, showTime, hiddenFields, trigger, format);
        ...
        dateField_sdate: function(showTime, attributes, hiddenFields){
            return fossirUI.Widgets.Generic.dateField(showTime, attributes, hiddenFields, {'id':'sdate', 'name':'sdate'});
        },

        dateField_edate: function(showTime, attributes, hiddenFields){
            return fossirUI.Widgets.Generic.dateField(showTime, attributes, hiddenFields, {'id':'edate', 'name':'edate'});
        }
    }
};
