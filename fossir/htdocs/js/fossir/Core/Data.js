...
// Place where to put page-wide fossir-related global variables
var fossirGlobalVars = {};
...
var Util = {
    ...
    dateTimefossirToJS: function(obj) {
...
var fossirDateTimeFormats = {
    International: '%d/%m/%Y %H:%M',
    ISO8601: '%Y/%m/%d %H:%M',
    Ordinal: '%Y%m%d'
};

fossirDateTimeFormats.Default = fossirDateTimeFormats.International;
fossirDateTimeFormats.Server = fossirDateTimeFormats.ISO8601;

fossirDateTimeFormats.DefaultHourless = fossirDateTimeFormats.Default.split(' ')[0];
fossirDateTimeFormats.ServerHourless = fossirDateTimeFormats.Server.split(' ')[0];
