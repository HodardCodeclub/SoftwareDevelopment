...
from fossir.legacy.common.contribPacker import ZIPFileHandler
from fossir.legacy.pdfinterface.conference import AbstractBook, ContribsToPDF, ContribToPDF, ProgrammeToPDF
from fossir.legacy.webinterface.pages.static import (WPStaticAuthorList, WPStaticConferenceDisplay,
...
from fossir.modules.events.contributions.controllers.display import (RHAuthorList, RHContributionAuthor,
                                                                     RHContributionDisplay, RHContributionList,
                                                                     RHSpeakerList, RHSubcontributionDisplay)
from fossir.modules.events.contributions.util import get_contribution_ical_file
from fossir.modules.events.layout.models.menu import MenuEntryType
from fossir.modules.events.layout.util import menu_entries_for_event
from fossir.modules.events.models.events import EventType
from fossir.modules.events.registration.controllers.display import RHParticipantList
from fossir.modules.events.sessions.controllers.display import RHDisplaySession
from fossir.modules.events.sessions.util import get_session_ical_file, get_session_timetable_pdf
from fossir.modules.events.timetable.controllers.display import RHTimetable
from fossir.modules.events.timetable.util import get_timetable_offline_pdf_generator
from fossir.modules.events.tracks.controllers import RHDisplayTracks
from fossir.util.string import strip_tags
...
class OfflineEventCreator(object):
    def __init__(self, rh, event):
        ...
        self._htdocs_dir = os.path.join(get_root_path('fossir'), 'htdocs')
    ...
    def create(self):
        ...
        # Add i18n js
        self._addFolderFromSrc(os.path.join(self._staticPath, 'js', 'fossir', 'i18n'),
                               os.path.join(self._htdocs_dir, 'js', 'fossir', 'i18n'))
