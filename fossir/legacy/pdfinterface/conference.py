...
from fossir.legacy.common import utils
from fossir.legacy.pdfinterface.base import (PageBreak, Paragraph, PDFBase, PDFLaTeXBase, PDFWithTOC, Spacer, escape,
                                             modifiedFontSize)
from fossir.legacy.webinterface.common.tools import strip_ml_tags
from fossir.modules.events.abstracts.models.abstracts import AbstractReviewingState, AbstractState
from fossir.modules.events.abstracts.models.reviews import AbstractAction
from fossir.modules.events.abstracts.settings import BOACorrespondingAuthorType, BOASortField, boa_settings
from fossir.modules.events.layout.util import get_menu_entry_by_name
from fossir.modules.events.registration.models.items import PersonalDataType
...
from fossir.modules.events.util import create_event_logo_tmp_file
from fossir.util.date_time import format_date, format_datetime, format_human_timedelta, format_time, now_utc
from fossir.util.i18n import _, ngettext
from fossir.util.string import format_full_name, html_color_to_rgb, to_unicode, truncate


# Change reportlab default pdf font Helvetica to fossir ttf font,
