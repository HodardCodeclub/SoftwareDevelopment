...
<script type="text/javascript">
    ...
    {
        var startDate = fossirUI.Widgets.Generic.dateField_sdate(false,null,['sDay', 'sMonth', 'sYear']);
        $E('sDatePlace').set(startDate);

        var endDate = fossirUI.Widgets.Generic.dateField_edate(false,null,['eDay', 'eMonth', 'eYear']);
        ...
        startDate.observe(function(value) {
            if ( fossirUtil.parseDate(startDate.get()) > fossirUtil.parseDate(endDate.get()) ) {
