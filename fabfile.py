...
"""
fabfile for fossir development operations
"""
...
env.update({
    ...
    'target_dir': os.path.join(SOURCE_DIR, 'fossir', 'htdocs'),
...
def lib_dir(src_dir, dtype):
    target_dir = os.path.join(src_dir, 'fossir', 'htdocs')
...
def setup_deps(n_env=None, n_version=None, src_dir=None, system_node=None):
    """
    Setup (fetch and install) dependencies for fossir assets
    """
